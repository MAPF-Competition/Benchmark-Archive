...
def parse_arguments():
    ...
    parser.add_argument("--config", type=str, help="{ath to the configuration file", default=None)
    # Add arguments to the parser

    parser.add_argument('--mapFile', type=str, help='Path to an existing map file. The map file is produced by map_generator.py or any grid map in the standard format.')
    parser.add_argument('--taskFile', default=None, help='Path to an existing task file generated by task_generator.py.')
